...
int main(int argc, char *argv[])
{
  ...
  xbuf_ncat(reply, data->followers_page->ptr, data->followers_page->len);
  xbuf_repl(reply, "<!--title-->", "<!--viewing_user's_username-->'s followers");
  ...
  return get_followers_list(RA_, reply, uid);
}
